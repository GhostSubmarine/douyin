                ...
                <div class="comment-container">
                  ...
                  <div class="time-wrapper">
                    <div class="left">
                      ...
                      <div class="time">
                        {{ item.time }}{{ item.ip_location && ` · ${item.ip_location}` }}
                      </div>
      ...
      <div class="input-toolbar">
        ...
        <div class="toolbar">
          <div class="input-wrapper">
            <AutoInput v-model="comment" placeholder="发评人，发评魂，发评都是人中神"></AutoInput>
            <div class="right">
              <!-- <img src="../assets/img/icon/message/call.png" /> -->
              <img src="../assets/img/icon/message/emoji-white.png" />
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      let res: any = await videoComments({ vid: this.videoId, type: ENUM[this.active] })
